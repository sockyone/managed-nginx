...
local dynamic_config = ngx.shared.config
local blacklist_ips = cjson.decode(dynamic_config:get("blacklist_ips"))
local whitelist_ips = cjson.decode(dynamic_config:get("whitelist_ips"))
local under_attack_mode = cjson.decode(dynamic_config:get("under_attack_mode"))
...
local ip_whitelist = whitelist_ips
...
local ip_blacklist = blacklist_ips
...
local master_switch = under_attack_mode --enabled by default
